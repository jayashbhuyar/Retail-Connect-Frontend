...
const Chat = () => {
  ...
  const fetchAcceptedUsers = async (email) => {
    try {
      const response = await fetch(
        `https://retail-connect-backend.onrender.com/api/network/accepted/${email}`,
        {
          credentials: "include",
          headers: {
        ...
        networkData.map(async (user) => {
          ...
          try {
            const conversationRes = await fetch(
              `https://retail-connect-backend.onrender.com/api/chat/conversations/${email}/${otherEmail}`,
              {
                credentials: "include",
              }
            );
  ...
  const fetchChats = async (conversationId) => {
    try {
      const response = await fetch(
        `https://retail-connect-backend.onrender.com/api/chat/${conversationId}`,
        {
          credentials: "include",
        }
      );
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch("https://retail-connect-backend.onrender.com/api/chat/chats", {
        method: "POST",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
